  ...
  return (
    <div className={cn("tk-container", className)} {...props}>
      <style>{`
        ...
        .tk-keyboard { width: 500px; height: 160px; }
        ...
        .tk-keys { display: flex; justify-content: space-between; width: 100%; transform: translateZ(4px); padding: 0 2px; }
