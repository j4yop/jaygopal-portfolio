...
export function Hero({ glitch: Glitch }: { glitch: ComponentType<any> }) {
  return (
    <section className="min-h-screen flex flex-col justify-center items-center px-4 pt-20 relative overflow-hidden border-b-4 border-black bg-neo-white">
      {/* Particle name — fills the hero, sits behind everything */}
      <div className="absolute inset-0 z-0">
        <InteractiveParticles
          src="/images/name-particles.png?v=2"
          allowUpload={false}
          background="#FBFF48"
          color="#121212"
          size={1.0}
      ...
      <div className="relative z-10 text-center max-w-5xl">
        ...
        <h1 className="text-[12vw] md:text-[9vw] leading-[0.85] font-black uppercase tracking-tighter mb-6 reveal mix-blend-darken sr-only">
          JAY GOPAL TRIPATHY
        </h1>
